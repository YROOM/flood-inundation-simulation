...
<div id="menu">
    ...
    <form action="KuikouServlet" method="post">
        ...
        <font size="3" color="white">单次淹没米数：</font><input type="text" name="password"></p>
        <p>
            <input type="submit" value="淹没展示">
            <input type="reset" value="面形式展示">
            <input type="reset" value="水深效果展示nmmmm">
        </p>
    </form>
...
<script>
    ...
    var mxPin = viewer.entities.add({
        name: "溃口点",
        position: Cesium.Cartesian3.fromDegrees(118.30767708040135,29.705766652836747),
        billboard: {
    ...
    var position = Cesium.Cartesian3.fromDegrees( ${FloodPoint.longitude}, ${FloodPoint.latitude},165);
     //var s=${FloodPoint.grid}/46;
    pointPrimitives.add({
        pixelSize: 5,
        //color: Cesium.Color['BLUE'].withAlpha(s),
